...
(async()=>{
  ...
  try {
    ...
    for(const [width,theme] of [[736,'light'],[360,'light'],[1024,'dark']]){
      ...
      await page.goto('file:///C:/Users/lgonz/Projects/market-bot/output/uuuu-velas-reales-preview.html');
      const frame=page.frameLocator('iframe');
      await frame.locator('.candle').first().waitFor();
      const state=await frame.locator('#uuuu-real').evaluate(el=>({
      ...
      await page.screenshot({path:`C:/Users/lgonz/Projects/market-bot/output/uuuu-real-${width}.png`,fullPage:true});
