...
def validate_strategy(implementation: str, source: StrategySource) -> None:
    if implementation not in {"1.4.0", "1.5.0", "1.8.0", "1.9.0", "1.10.0"}:
        return
...
def configure_engine(
    ...
    if implementation in {"1.8.0", "1.9.0", "1.10.0"}:
