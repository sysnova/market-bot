...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RuleLifecycleStatus.VALIDATED, StrategyMode.CANDIDATE, RuntimeEnvironment.LIVE, True),
        (RuleLifecycleStatus.DRAFT, StrategyMode.CANDIDATE, RuntimeEnvironment.LIVE, False),
