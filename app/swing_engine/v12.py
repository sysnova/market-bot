"""Native-zone-first Support Confirmation enrichment for Swing v12."""
...
class SwingEngineV12(SwingEngineV11):
    """Keep Swing geometry authoritative and classify Support as corroboration."""
