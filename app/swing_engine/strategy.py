...
def validate_strategy(implementation: str, source: StrategySource) -> None:
    ...
    if implementation in {"8.0.0", "9.0.0", "10.0.0", "11.0.0", "14.0.0", "15.0.0", "16.0.0"}:
        behavior = source.behavior()
    ...
    if (
        implementation in {"10.0.0", "11.0.0", "14.0.0", "15.0.0", "16.0.0"}
    ...
    if implementation in {"11.0.0", "14.0.0", "15.0.0", "16.0.0"}:
        source.behavior().positive_int("support_freshness_sessions")
    if implementation in {"14.0.0", "15.0.0", "16.0.0"}:
        behavior = source.behavior()
...
def configure_engine(
    ...
    if implementation in {
        ...
        if implementation in {"10.0.0", "11.0.0", "14.0.0", "15.0.0", "16.0.0"}:
