...
from app.swing_4h_geri_engine import (
    ...
    Swing4HGeriEngineV111,
    Swing4HGeriEngineV112,
    Swing4HGeriEngineV113,
)
...
from app.swing_trade_engine import (
    ...
    SwingTradeEngineV18,
    SwingTradeEngineV19,
    SwingTradeEngineV110,
    SwingTradeEngineV111,
    SwingTradeEngineV112,
)
    ...
    return EngineRegistry(
        {
            ...
            EngineSlot.GERI_4H: EngineRegistration(
                implementations={
                    ...
                    "1.11.0": Swing4HGeriEngineV111,
                    "1.12.0": Swing4HGeriEngineV112,
                    "1.13.0": Swing4HGeriEngineV113,
                },
            ...
            EngineSlot.SWING_TRADE: EngineRegistration(
                implementations={
                    ...
                    "1.10.0": SwingTradeEngineV110,
                    "1.11.0": SwingTradeEngineV111,
                    "1.12.0": SwingTradeEngineV112,
                },
