...
The active distributed analytical generation is selected by `configs/marketbot/7.11.0.yaml`:
Long 2, Swing 5, Intraday 4, Entry Watcher 5.4, Entry Opportunity 3.0, Alert 3.5,
Entry Recovery 1.1, Volume Structure 1.1, and Options Gamma 1.0.
Patreon Caps, Elliott Wave, Support Confirmation, and Signal Fusion remain available on demand but are excluded
