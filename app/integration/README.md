...
The active distributed analytical generation is selected by `configs/marketbot/7.4.0.yaml`:
Long 2, Swing 4, Intraday 4, Entry Watcher 5.1, Entry Opportunity 2.0, Alert 3.4,
