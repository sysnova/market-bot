...
The active distributed analytical generation is selected by `configs/marketbot/7.5.0.yaml`:
Long 2, Swing 4, Intraday 4, Entry Watcher 5.2, Entry Opportunity 3.0, Alert 3.4,
Entry Recovery 1.1, Volume Structure 1.1, and Signal Fusion 0.4.
