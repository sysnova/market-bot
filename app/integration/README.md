...
Alpaca WebSocket, persistent Entry Watcher v2, and Alert v2 aggregation have their own process
...
`distributed_composition.py`: Long v2, Swing v2, Intraday v2, Entry Watcher v2, and Alert v2. Earlier classes and the
