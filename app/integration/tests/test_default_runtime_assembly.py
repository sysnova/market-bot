...
def test_default_entry_points_select_corrected_swing_trade(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert assembly.definition.version == "7.71.0"
    assert assembly.spec(EngineSlot.SWING_TRADE).implementation == "1.11.0"
    assert assembly.spec(EngineSlot.SWING_TRADE).strategy.version == "1.8.0"
