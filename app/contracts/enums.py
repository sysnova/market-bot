...
class AlertKind(ContractEnum):
    ...
    NEWS_RISK = "NEWS_RISK"
    LEVERAGED_THESIS_EARLY = "LEVERAGED_THESIS_EARLY"
    LEVERAGED_THESIS_BUY = "LEVERAGED_THESIS_BUY"
    LEVERAGED_THESIS_CANCELLED = "LEVERAGED_THESIS_CANCELLED"
...
class EntrySignalFamily(ContractEnum):
    ...
    LEVERAGED_THESIS = "LEVERAGED_THESIS"
...
class EntryCloseReason(ContractEnum):
    ...
    SWEEP_RECLAIM_CANCELLED = "SWEEP_RECLAIM_CANCELLED"
    EXPIRED = "EXPIRED"
