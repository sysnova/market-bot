...
1. `ticker-cache` comprueba Redis y limpia �nicamente las ventanas, �ndices y
   contextos propios de engines antes de publicar su endpoint y readiness.
   Conserva las barras can�nicas `history:*`, sus metadatos de cobertura y los
   snapshots de eventos. Al liberar referencias elimina s�lo los payloads que
